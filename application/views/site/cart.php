	    ...
	    <div class="cart-left-container">
			...
			<table class="table table-bordered">
				...
				<tr class="cart-header">
                    ...
                    <th colspan="2" class="text-right">TOTAL <i class="fa fa-inr rs-sym"></i> <?php echo number_format($total[0]['price']).'.00'; ?> </th>				    
				</tr>
				...
				<tr class="cart-prodict-list ">
				    ...
				    <form action="<?php echo base_url('Cart/update_cart/'.$c['id']); ?>" method="post" enctype="multipart/form-data">
  ...
  <div id="collapse-coupon" class="panel-collapse collapse">
    <div class="panel-body">
		...
		<div class="row button-section shopping-btn">
			...
			<a href="<?php echo base_url('update-address'); ?>" class="btn btn-primary btn-block checkout-btn">Checkout</a>
                                                		    </div>
		</div>
	    </div>

...
<style>
  ...
  #column_left .box-no-advanced .products .product .sale,
  #column_left .box-no-advanced .products .product .new {
    display: block;
  }
...
<body>
        ...
        <div class="fullwidth" id="camera_1">
          ...
          <div class="camera_slider">
            ...
            <div class="camera_wrap carousel-inner" id="camera_wrap_1" style="overflow: hidden; margin: auto; height: px; max-width: px;">
              ...
              <div style="width:100%;">
                <a href="products/12032" class="">
                  <img src="images/loader1920x575bfbf.gif?width=&amp;height=&amp;mode=fill&amp;fill=solid&amp;fill-color=FFFFFF" data-src="images/sp3.png" title="Slider" alt="Slider" class="lload img-responsive" width="100%" height="550">
                </a>
              </div>
              <div style="width:100%;">
                <a href="products/12030" class="">
  ...
  ?>
    <div class="messages">
      <div class="alert alert-success cart-added-success-message"><?php echo $this->session->flashdata('error'); ?><button type="button" class="close" data-dismiss="alert" style="color:white;display:block;">X</button></div>
    </div>
  <?php
  }
  ...
  ?>
    <div class="messages">
      <div class="alert alert-success cart-added-success-message"><?php echo $this->session->flashdata('success'); ?><button type="button" class="close" data-dismiss="alert" style="color:white;display:block;">X</button></div>
    </div>
  <?php
  }
  ?>
  ...
  ?>
    <div class="messages">
      <div class="alert alert-success cart-added-success-message"><?php echo $this->session->flashdata('error1'); ?><button type="button" class="close" data-dismiss="alert" style="color:white;display:block;">X</button></div>
    </div>
  <?php
  }
  ...
  ?>
    <div class="messages">
      <div class="alert alert-success cart-added-success-message"><?php echo $this->session->flashdata('success1'); ?><button type="button" class="close" data-dismiss="alert" style="color:white;display:block;">X</button></div>
    </div>
  <?php
  }
  ?>
            ...
            <div class="col-sm-12">
                                        ...
                                        <div class="product-layout product-item product-grid">
                                          <div class="product-thumb size-option">
                                            <div class="card">
                                              ...
                                              <a href="<?php echo base_url('product/' . $p['pack_product_id']); ?>">
                                                <h1 style="font-size: 15px;font-weight: bold;text-transform: uppercase;color:#006400;padding: 25px;height:90px"><?php echo $p['pack_name']; ?></h1>
                                              </a>
                                    ...
                                    <?php foreach ($top as $t) { ?>
                                      <div class="col-sm-4 col-xs-6 zoom box" style="border:none">
                                        ...
                                        <div class="product-layout product-item product-grid">
                                          <div class="product-thumb size-option">
                                            <div class="card">
                                              <a href="<?php echo base_url('product-detail/' . $t['product_id']); ?>">
                                                <h1 style="font-size: 15px;font-weight: bold;text-transform: uppercase;color: #006400;padding: 25px;height:90px"><?php echo $t['p_name']; ?></h1>
                                              </a>
                                              <a href="<?php echo base_url('product-detail/' . $t['product_id']); ?>"> <img src="<?php echo base_url('thumbnail/' . $t['p_image']); ?>" style=" border-radius:10%; max-width: 100%;margin:-35px;height: 220px;"></a>
              ...
              ?>
                <div class="box clearfix box-with-products with-scroll box-no-advanced" style="margin-top:25px;background-image: url(image/);">
                  ...
                  <?php } ?>
                  <div class="container">
                    <div class="box-heading" style="font-weight:bold;text-transform:uppercase;padding-bottom: 31px;line-height:0;width: 101.5%;padding-top: 26px;">Popular Searches</div>
                    <div class="strip-line"></div>
                    <div class="clear"></div>
                    <div class="box-content products">
                      <div class="box-product">
                                    ...
                                    <?php foreach ($popular as $pl) { ?>
                                      <div class="col-sm-4 col-xs-6 zoom box" style="border:none">
                                        ...
                                        <div class="product-layout product-item product-grid">
                                          <div class="product-thumb size-option">
                                            <div class="card">
                                              <a href="<?php echo base_url('product-detail/' . $pl['product_id']); ?>">
                                                <h1 style="font-size: 15px;font-weight: bold;text-transform: uppercase;color: #006400;padding: 25px;height:90px"><?php echo $pl['p_name']; ?></h1>
                                              </a>
                                              <a href="<?php echo base_url('product-detail/' . $pl['product_id']); ?>"> <img src="<?php echo base_url('thumbnail/' . $pl['p_image']); ?>" style=" border-radius:10%; max-width: 100%;margin:-35px;height: 220px;"></a>
              ...
              <div class="box clearfix box-with-products with-scroll box-no-advanced" style="margin-top:25px;">
                ...
                <div class="row home-tilbanner " style="display: flex; justify-content: space-evenly; ">
                  <div class="clearfix"></div>
                  <?php foreach ($popular_cat as $pt) { ?>
                    <div class="col-xs-6 col-sm-3 zoom box" style=" display:flex; justify-content: space-evenly;">
                      <a href="<?php echo base_url('products/' . $pt['cat_id']); ?>" class="">
                        <img src="<?php echo base_url('category/' . $pt['cat_image']); ?>" class="img-responsive" style="border-radius: 10%;width: 310px; height:150px;">
                        <span></span>
                      </a>
                    </div>
                  <?php } ?>
              ...
              <div id="slider" class="fixed">
                      ...
                      <div class="camera_slider">
                        ...
                        <div class="camera_wrap carousel-inner owl-carousel owl-theme" id="camera_wrap_11" style="overflow: initial;background-image: url(images/bac/fresh2.jpeg);width: 100%;margin: auto;height: 389px;opacity: 1;display: block;">
                          <div class="testimonial">
                            ...
                            <p class="description">
                              <i class="fa fa-quote-left" aria-hidden="true" style="font-size:35px;color:#DCDCDC;margin-right:7px;"></i> Kaju Wale Bhaiya is one of the best shops to purchase quality dry fruits. I have purchased Cashew from this shop, and the quality and taste of the product are excellent.
                            </p>
                          ...
                          <div class="testimonial">
                            ...
                            <p class="description">
                              <i class="fa fa-quote-left" aria-hidden="true" style="font-size:35px;color:#DCDCDC;margin-right:7px;"></i> I'm delighted with the dry fruit product that I paid for. Hence, I will recommend other people to purchase quality dry fruit and masalas from this place.
                            </p>
                            <span class="star_r title1">
                              <i class="fa fa-star font-12" aria-hidden="true" style="color:orange"></i>
                              <i class="fa fa-star font-12" aria-hidden="true" style="color:orange"></i>
                            ...
                            <h3 class="title">Chandrakant Arya</h3>
                          </div>
                          <div class="testimonial">
                            <div class="pic">
                              <img src="<?php echo base_url(); ?>images/users.png" alt="">
                            ...
                            <p class="description">
                              <i class="fa fa-quote-left" aria-hidden="true" style="font-size:35px;color:#DCDCDC;margin-right:7px;"></i> If you want to purchase chicken masala, coriander powder, and any masala to cook tasty food. It's a place where you can find 100% quality and natural products at wholesale prices.
                            </p>
                            <span class="star_r title1">
                              <i class="fa fa-star font-12" aria-hidden="true" style="color:orange"></i>
                              <i class="fa fa-star font-12" aria-hidden="true" style="color:orange"></i>
                            ...
                            <h3 class="title">Aparna Kalyan</h3>
                          </div>
                          <div class="testimonial">
                            <div class="pic">
                              <img src="<?php echo base_url(); ?>images/users.png" alt="">
                            ...
                            <p class="description">
                              <i class="fa fa-quote-left" aria-hidden="true" style="font-size:35px;color:#DCDCDC;margin-right:7px;"></i> I'm a regular Kaju Wale Bhaiya because he offers genuine dry fruit products in nicely packed packets. Also, the Cashew and other dry fruits available in this shop are affordable.
                            </p>
                            <span class="star_r title1">
                              <i class="fa fa-star font-12" aria-hidden="true" style="color:orange"></i>
                              <i class="fa fa-star font-12" aria-hidden="true" style="color:orange"></i>
                          ...
                          <div class="testimonial">
                            ...
                            <p class="description">
                              <i class="fa fa-quote-left" aria-hidden="true" style="font-size:35px;color:#DCDCDC;margin-right:7px;"></i> Whether you want to buy chili powder, coriander powder, or other masala powder. All are available with good quality packages and wholesale rates.
                            </p>
                            <span class="star_r title1">
                              <i class="fa fa-star font-12" aria-hidden="true" style="color:orange"></i>
                              <i class="fa fa-star font-12" aria-hidden="true" style="color:orange"></i>
                            ...
                            <h3 class="title">Shrinivas Durga</h3>
                          </div>
                          <div class="testimonial">
                            <div class="pic">
                              <img src="<?php echo base_url(); ?>images/users.png" alt="">
                            ...
                            <p class="description">
                              <i class="fa fa-quote-left" aria-hidden="true" style="font-size:35px;color:#DCDCDC;margin-right:7px;"></i> I'm impressed with the Cashew and other dry fruits I recently purchased here. Because the taste of these dry fruits is fantastic and also fresh.
                            </p>
                            <span class="star_r title1">
                              <i class="fa fa-star font-12" aria-hidden="true" style="color:orange"></i>
                              <i class="fa fa-star font-12" aria-hidden="true" style="color:orange"></i>
                          ...
                          <div class="testimonial">
                            ...
                            <p class="description">
                              <i class="fa fa-quote-left" aria-hidden="true" style="font-size:35px;color:#DCDCDC;margin-right:7px;"></i> Kaju Wale Bhaiya is a neat and clean shop based in India. You can even purchase its product on another marketplace such as Amazon. And it's the thing that makes it one of the legit and trusted dry fruit shops in India.
                            </p>
                            <span class="star_r title1">
                              <i class="fa fa-star font-12" aria-hidden="true" style="color:orange"></i>
                              <i class="fa fa-star font-12" aria-hidden="true" style="color:orange"></i>
                          ...
                          <div class="testimonial">
                            ...
                            <p class="description">
                              <i class="fa fa-quote-left" aria-hidden="true" style="font-size:35px;color:#DCDCDC;margin-right:7px;"></i> This is one of India's best shops to purchase cashews and other dry fruits. Because you do not get cheated and get what you see in the product image. Hence, I recommend you purchase dry fruits online from Kaju Wale Bhaiya.
                            </p>
                            <span class="star_r title1">
                              <i class="fa fa-star font-12" aria-hidden="true" style="color:orange"></i>
                              <i class="fa fa-star font-12" aria-hidden="true" style="color:orange"></i>
                          ...
                          <div class="testimonial">
                            ...
                            <p class="description">
                              <i class="fa fa-quote-left" aria-hidden="true" style="font-size:35px;color:#DCDCDC;margin-right:7px;"></i> It's the best wholesale and retail shop to purchase masala and dry fruits. You can purchase these fantastic products in an easy process.
                            </p>
                            <span class="star_r title1">
                              <i class="fa fa-star font-12" aria-hidden="true" style="color:orange"></i>
                              <i class="fa fa-star font-12" aria-hidden="true" style="color:orange"></i>
                ...
                <div class="container">
                  <div class="brandlogo">
                    <h3 style="font-weight:bold;">Our Presence</h3>
                    <div id="brandlogo">
                      <div class="owl-item">

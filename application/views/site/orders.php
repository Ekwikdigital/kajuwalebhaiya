    ...
    <div class="row" style="margin-top:30px;">
      <div class="col-md-12">
        ...
        <div id="profile" class="tabcontent">
          ...
          ?>
            <div class="message">
              <div class="alert alert-success cart-added-success-message" style="z-index:1"><?php echo $this->session->flashdata('error'); ?><button type="button" class="close" data-dismiss="alert" style="color:white;display:block;">X</button></div>
            </div>
          <?php
          }
          ...
          ?>
            <div class="message">
              <div class="alert alert-success cart-added-success-message" style="z-index:1"><?php echo $this->session->flashdata('success'); ?><button type="button" class="close" data-dismiss="alert" style="color:white;display:block;">X</button></div>
            </div>
          <?php
          }
          ?>
          ...
          ?>
            <div class="message">
              <div class="alert alert-success cart-added-success-message" style="z-index:1"><?php echo $this->session->flashdata('error1'); ?><button type="button" class="close" data-dismiss="alert" style="color:white;display:block;">X</button></div>
            </div>
          <?php
          }
          ...
          ?>
            <div class="message">
              <div class="alert alert-success cart-added-success-message" style="z-index:1"><?php echo $this->session->flashdata('success1'); ?><button type="button" class="close" data-dismiss="alert" style="color:white;display:block;">X</button></div>
            </div>
          <?php
          }
          ?>
          <fieldset>
            ...
            <?php } else { ?>
              <div class="empty-product">
                <p style="margin-top: 12px;">You have not made any orders yet!</p>
              </div>
            <?php } ?>
          </fieldset>

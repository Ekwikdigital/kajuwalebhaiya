...
<div class="container-fluid">
 ...
 <?php 
        ...
        <li>Checkout</li>
	     ...
	     <div class="cart-right-container">
			...
			<table class="table table-bordered">
			    <tbody>
			        <?php $total = $this->common_model->getsumprice($this->session->userdata('u_id')); ?>
				...
				<tr class="cart-prodict-list ">
					...
					<div class="row">
						...
						<!--<div class="visible-xs"><a href="">Signature California Walnut Kernels- 200G (Pack Of 2)</a></div> -->
				    ...
				    <form action="<?php echo base_url('Cart/update/'.$c['id']); ?>" method="post" enctype="multipart/form-data">
		...
		<div class="cart-total">
		    ...
		    <table>
             ...
             <!--       	<tr >
			    ...
			    <td class="text-right"><i class="fa fa-inr rs-sym"></i> <?php echo $c['price']; ?></td>
			</tr>
					    </table>
		</div>
	<div class="row button-section shopping-btn">
			...
			<a href="<?php echo base_url('order-confirm'); ?>" class="btn btn-primary btn-block checkout-btn">Confirm Order</a>

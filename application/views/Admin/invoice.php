    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 body-main">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4"> <img src="<?php echo base_url();?>image/resize-164310701455515656KWBpngtransparent1.png" title="Evergreennuts" alt="Evergreennuts" class="img"  /> </div>
                        <div class="col-md-8 text-right">
                           <!-- <h4 style="color: #F81D2D;"><strong>Evergreennuts</strong></h4>
                            <p>221 ,Baker Street</p>
                            <p>1800-234-124</p>
                            <p>example@gmail.com</p>-->
                            
    	<a href="<?php echo base_url('orders'); ?>"><button id="home" class="btn btn-md btn-success">Back</button> </a>
      <input type="button" id="btnprint" class="btn btn-md" value="Print" onclick="print_page()" />
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2>INVOICE</h2>
                            <h5><?php echo $orders['order_id']; ?></h5>
                        </div>
                    </div> <br />
                    <div>
                        <table class="table">

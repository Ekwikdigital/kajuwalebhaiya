      ...
      ?>
            <div class="card">
              <div class="card-header">
                ...
                <a href="<?php echo base_url('add_product'); ?>"><input type="submit" value="Add New Product" class="btn btn-success float-right"></a>
              </div>
              <div class="row">
        <div class="col-12">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo $list['p_discount']; ?></td>
                                        <td><?php echo $list['p_description']; ?></td>
                    <td><?php  echo $list['p_create_date']; ?></td>
                    <td><a class="btn btn-info btn-sm" href="<?php echo base_url('edit_product/'.$list['pid']); ?>">
                      <i class="fas fa-pencil-alt"></i>Edit</a>
                      <a class="btn btn-danger btn-sm" href="<?php echo site_url('Admin/Product/delete_product/'.$list['pid']); ?>" onclick="return confirm('Are you sure! you want to delete this product?');"><i class="fas fa-trash"></i>Delete</a>

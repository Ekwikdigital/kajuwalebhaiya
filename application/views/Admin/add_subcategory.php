          ...
          <div class="card card-primary">
			...
			<span style="color: red;"><?php echo form_error('product_cat'); ?>  </span>
              ...
              <div class="form-group">
                ...
                <input type="text" id="cat_sub_id" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" name="cat_sub_id" class="form-control" value="<?php echo set_value('cat_sub_id'); ?>">
              ...
              <div class="form-group">
                ...
                <input type="text" id="sub_cat_name" name="sub_cat_name" class="form-control" value="<?php echo set_value('sub_cat_name'); ?>">
                <span style="color: red;"><?php echo form_error('sub_cat_name'); ?>  </span>
              </div>
              <div class="form-group">
                <label for="inputProjectLeader">Status</label>
                <input type="checkbox" name="sub_cat_status" value="1" checked id="sub_cat_status">
              </div>
              <div class="row">
        <div class="col-12">
